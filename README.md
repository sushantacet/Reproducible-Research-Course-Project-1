...
* The R Markdown document, containing the R code and written explanations, can be found in the file [PA1_template](PA1_template.Rmd). The same document, in Markdown format, can be found at [PA1_template.md](PA1_template.md), and the HTML version at [PA1_template.html](PA1_template.html).
